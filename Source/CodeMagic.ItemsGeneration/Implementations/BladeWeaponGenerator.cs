...
namespace CodeMagic.ItemsGeneration.Implementations
{
    internal class BladeWeaponGenerator : WeaponGeneratorBase
    {
        ...
        public BladeWeaponGenerator(string baseName, IBladeWeaponConfiguration configuration, IImagesStorage imagesStorage) 
            : base(baseName, imagesStorage)
        {
        ...
        protected override string[] GenerateDescription(ItemRareness rareness, ItemMaterial material)
        {
            return new[]
            {
