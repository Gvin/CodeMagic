...
{
    SymbolsImage GetImage(IMapObject objectToDraw);
}
...
public class WorldImagesFactory : IWorldImagesFactory
{
    ...
    public SymbolsImage GetImage(IMapObject objectToDraw)
    {
    ...
    private SymbolsImage GetObjectImage(IMapObject objectToDraw)
    {
